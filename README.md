...
placeholder content — `Rain Chen`, a generic hero image, and so on.
...
> Replace every "Rain Chen" placeholder in this site with my name,
> "Rain Chen." Update the LinkedIn and GitHub links in index.html's social
> box to my profiles: <your LinkedIn URL> and <your GitHub URL>.

Things to personalize:

- [ ] Your name, replacing `Rain Chen` everywhere it appears.
